...
<h1 class="page-title"><?php _e( 'Category Archives:', 'my-theme' ) ?> <span><?php single_cat_title() ?></span></span></h1>
...
<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'my-theme' )  ); ?>
                    ...
                    <div class="entry-utility">
                        ...
                        <span class="cat-links"><?php printf( __( 'Also posted in %s', 'my-theme' ), $cats_meow ) ?></span>
                        <span class="meta-sep"> | </span>
<?php endif ?>
                        <span class="meta-sep"> | </span>
